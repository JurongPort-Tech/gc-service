...
public class GbccCargoTimesheetEqrentalId implements Serializable
{
    ...
    public GbccCargoTimesheetEqrentalId() {
    }

    public GbccCargoTimesheetEqrentalId(String vvCd, Date createDttm, Integer recSeqNbr) {
        this.vvCd = vvCd;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GbccCargoTimesheetEqrentalId)) {
            return false;
        }
        GbccCargoTimesheetEqrentalId other = ((GbccCargoTimesheetEqrentalId) o);
        if (this.vvCd == null) {
            if (other.vvCd!= null) {
                return false;
            }
