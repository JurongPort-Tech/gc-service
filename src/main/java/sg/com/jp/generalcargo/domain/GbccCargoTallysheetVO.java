...
public class GbccCargoTallysheetVO   extends AuditLogRecord implements Serializable {
	 ...
	 * 
	 */
	private GbccCargoTallysheetId id;
	private String vvCd;
    ...
    private String checkerHp;
    private Date workCommenceDttm;
    private Date workCompleteDttm;
	...
	private String beth_lastModifyUserId;
	private Date beth_lastModifyDttm;
    ...
    private List<GbccCargoTallysheetDet> cargoTallysheetDetVO;
    
    private BigDecimal totDiscOpenBal;//total discharge
    private BigDecimal totLoadOpenBal;//total load
    private Integer totPkgsDiscOpenBal;
    private Integer totPkgsLoadOpenBal;
   
    private BigDecimal totDiscTotalCompleted; //overall total by vv_cd and stev_cd
    private BigDecimal totLoadTotalCompleted; //overall total by vv_cd and stev_cd
    private Integer totQtyDiscTotalCompleted; //overall total by vv_cd and stev_cd
    private Integer totQtyLoadTotalCompleted; //overall total by vv_cd and stev_cd
    
    private BigDecimal totDiscCompleted;	//total of this shift //Handle Discharge
    private BigDecimal totLoadCompleted;  //total of this shift //Handle load
    private Integer totQtyDiscCompleted;	//total of this shift
    private Integer totQtyLoadCompleted;  //total of this shift
    
    private String oprTypeName;
    // START: Added by VietNguyen 28-May-2012 for StevedoreNet
    private String tallyCheckerNm;//Tally Clerk Name 
    private String tallyCheckerHp;//Tally Clerk Number 
    private String vesselVoyage;//for display field Vessel/Voyage at listing
    ...
    private Integer  tot_pkgs_disc_openbal;
    private BigDecimal tot_disc_openbal;
    private Integer tot_pkgs_load_openbal;
    private BigDecimal tot_load_openbal;
    private Integer tot_completed_qty_disc;
    private BigDecimal tot_completed_disc;
    private Integer tot_completed_qty_load;
    private BigDecimal tot_completed_load;
  
	
    public GbccCargoTallysheetVO() {
    }

    public GbccCargoTallysheetVO(String stevCoCd, String checkerNm, String checkerHp, Date workCommenceDttm, Date workCompleteDttm, Date fromDttm, Date toDttm, Date submittedDttm, String lastModifyUserId, Date lastModifyDttm) {
        this.stevCoCd = stevCoCd;
        this.checkerNm = checkerNm;
        this.checkerHp = checkerHp;
        this.workCommenceDttm = workCommenceDttm;
        this.workCompleteDttm = workCompleteDttm;
    ...
    public GbccCargoTallysheetVO(GbccCargoTallysheetId id, String stevCoCd, String checkerNm, String checkerHp, Date workCommenceDttm, Date workCompleteDttm, Date fromDttm, Date toDttm, Date submittedDttm, String lastModifyUserId, Date lastModifyDttm) {
        this.id = id;
        this.stevCoCd = stevCoCd;
        this.checkerNm = checkerNm;
        this.checkerHp = checkerHp;
	...
	public Integer getTot_pkgs_disc_openbal() {
		return tot_pkgs_disc_openbal;
	}

	public void setTot_pkgs_disc_openbal(Integer tot_pkgs_disc_openbal) {
		this.tot_pkgs_disc_openbal = tot_pkgs_disc_openbal;
	}

	public BigDecimal getTot_disc_openbal() {
		return tot_disc_openbal;
	}

	public void setTot_disc_openbal(BigDecimal tot_disc_openbal) {
		this.tot_disc_openbal = tot_disc_openbal;
	}

	public Integer getTot_pkgs_load_openbal() {
		return tot_pkgs_load_openbal;
	}

	public void setTot_pkgs_load_openbal(Integer tot_pkgs_load_openbal) {
		this.tot_pkgs_load_openbal = tot_pkgs_load_openbal;
	}

	public BigDecimal getTot_load_openbal() {
		return tot_load_openbal;
	}

	public void setTot_load_openbal(BigDecimal tot_load_openbal) {
		this.tot_load_openbal = tot_load_openbal;
	}

	public Integer getTot_completed_qty_disc() {
		return tot_completed_qty_disc;
	}

	public void setTot_completed_qty_disc(Integer tot_completed_qty_disc) {
		this.tot_completed_qty_disc = tot_completed_qty_disc;
	}

	public BigDecimal getTot_completed_disc() {
		return tot_completed_disc;
	}

	public void setTot_completed_disc(BigDecimal tot_completed_disc) {
		this.tot_completed_disc = tot_completed_disc;
	}

	public Integer getTot_completed_qty_load() {
		return tot_completed_qty_load;
	}

	public void setTot_completed_qty_load(Integer tot_completed_qty_load) {
		this.tot_completed_qty_load = tot_completed_qty_load;
	}

	public BigDecimal getTot_completed_load() {
		return tot_completed_load;
	}

	public void setTot_completed_load(BigDecimal tot_completed_load) {
		this.tot_completed_load = tot_completed_load;
	}
	...
	public String getBeth_lastModifyUserId() {
		return beth_lastModifyUserId;
	}

	public void setBeth_lastModifyUserId(String beth_lastModifyUserId) {
		this.beth_lastModifyUserId = beth_lastModifyUserId;
	}

	public Date getBeth_lastModifyDttm() {
		return beth_lastModifyDttm;
	}

	public void setBeth_lastModifyDttm(Date beth_lastModifyDttm) {
		this.beth_lastModifyDttm = beth_lastModifyDttm;
	}
	...
	public GbccCargoTallysheetId getId() {
        return id;
    }

    public void setId(GbccCargoTallysheetId id) {
        this.id = id;
    }
    ...
    public String getCheckerHp() {
        return checkerHp;
    }

    public void setCheckerHp(String checkerHp) {
        this.checkerHp = checkerHp;
    }

    public Date getWorkCommenceDttm() {
        return workCommenceDttm;
    }

    public void setWorkCommenceDttm(Date workCommenceDttm) {
        this.workCommenceDttm = workCommenceDttm;
    }

    public Date getWorkCompleteDttm() {
        return workCompleteDttm;
    }

    public void setWorkCompleteDttm(Date workCompleteDttm) {
        this.workCompleteDttm = workCompleteDttm;
    }
    ...
    public List<GbccCargoTallysheetDet> getCargoTallysheetDetVO() {
    	if (cargoTallysheetDetVO == null)
    		cargoTallysheetDetVO = new ArrayList<GbccCargoTallysheetDet>();
    	
    	return cargoTallysheetDetVO;
    }
    
    public void setCargoTallysheetDetVO(List cargoTallysheetDetVO) {
    	this.cargoTallysheetDetVO = cargoTallysheetDetVO;
    }
    ...
    public BigDecimal getTotDiscOpenBal() {
        return totDiscOpenBal;
    }
    public void setTotDiscOpenBal(BigDecimal totDiscOpenBal) {
        this.totDiscOpenBal =totDiscOpenBal;
    }
    public BigDecimal getTotLoadOpenBal() {
        return totLoadOpenBal;
    }
    public void setTotLoadOpenBal(BigDecimal totLoadOpenBal) {
        this.totLoadOpenBal = totLoadOpenBal;
    }
    
    public Integer getTotPkgsDiscOpenBal() {
        return totPkgsDiscOpenBal;
    }
    public void setTotPkgsDiscOpenBal(Integer totPkgsDiscOpenBal) {
        this.totPkgsDiscOpenBal = totPkgsDiscOpenBal;
    }
    
    public Integer getTotPkgsLoadOpenBal() {
        return totPkgsLoadOpenBal;
    }
    public void setTotPkgsLoadOpenBal(Integer totPkgsLoadOpenBal) {
        this.totPkgsLoadOpenBal = totPkgsLoadOpenBal;
    }
    
    public BigDecimal getTotDiscCompleted() {
        return totDiscCompleted;
    }
    public void setTotDiscCompleted(BigDecimal totDiscCompleted) {
        this.totDiscCompleted = totDiscCompleted;
    }
    public BigDecimal getTotLoadCompleted() {
        return totLoadCompleted;
    }
    public void setTotLoadCompleted(BigDecimal totLoadCompleted) {
        this.totLoadCompleted = totLoadCompleted;
    }
    
    public Integer getTotQtyDiscCompleted() {
        return totQtyDiscCompleted;
    }
    public void setTotQtyDiscCompleted(Integer totQtyDiscCompleted) {
        this.totQtyDiscCompleted = totQtyDiscCompleted;
    }
    
    public Integer getTotQtyLoadCompleted() {
        return totQtyLoadCompleted;
    }
    public void setTotQtyLoadCompleted(Integer totQtyLoadCompleted) {
        this.totQtyLoadCompleted = totQtyLoadCompleted;
    }
    
    public BigDecimal getTotDiscTotalCompleted() {
        return totDiscTotalCompleted;
    }
    public void setTotDiscTotalCompleted(BigDecimal totDiscTotalCompleted) {
        this.totDiscTotalCompleted = totDiscTotalCompleted;
    }
    public BigDecimal getTotLoadTotalCompleted() {
        return totLoadTotalCompleted;
    }
    public void setTotLoadTotalCompleted(BigDecimal totLoadTotalCompleted) {
        this.totLoadTotalCompleted = totLoadTotalCompleted;
    }
    
    public Integer getTotQtyDiscTotalCompleted() {
        return totQtyDiscTotalCompleted;
    }
    public void setTotQtyDiscTotalCompleted(Integer totQtyDiscTotalCompleted) {
        this.totQtyDiscTotalCompleted = totQtyDiscTotalCompleted;
    }
    
    public Integer getTotQtyLoadTotalCompleted() {
        return totQtyLoadTotalCompleted;
    }
    public void setTotQtyLoadTotalCompleted(Integer totQtyLoadTotalCompleted) {
        this.totQtyLoadTotalCompleted = totQtyLoadTotalCompleted;
    }
    ...
    public String getTallyCheckerNm() {
		return tallyCheckerNm;
	}

	public void setTallyCheckerNm(String tallyCheckerNm) {
		this.tallyCheckerNm = tallyCheckerNm;
	}

	public String getTallyCheckerHp() {
		return tallyCheckerHp;
	}

	public void setTallyCheckerHp(String tallyCheckerHp) {
		this.tallyCheckerHp = tallyCheckerHp;
	}
	...
	public Integer getBalDiscQty() {
    	Integer balQty = new Integer(0);
    	
    	balQty = new Integer((CommonUtil.chkNull(this.totPkgsDiscOpenBal).intValue() - CommonUtil.chkNull(this.totQtyDiscTotalCompleted).intValue()) + CommonUtil.chkNull(this.totQtyDiscCompleted).intValue());
    	return balQty;
    }
    public Integer getBalLoadQty() {
    	Integer balQty = new Integer(0);
    	balQty = new Integer((CommonUtil.chkNull(this.totPkgsLoadOpenBal).intValue() - CommonUtil.chkNull(this.totQtyLoadTotalCompleted).intValue()) + CommonUtil.chkNull(this.totQtyLoadCompleted).intValue());
    	return balQty;
    }
    public BigDecimal getBalDiscTon() {
    	BigDecimal balTon = new BigDecimal(0);
    	balTon = new BigDecimal((CommonUtil.chkNull(this.totDiscOpenBal).doubleValue() - CommonUtil.chkNull(this.totDiscTotalCompleted).doubleValue()) + CommonUtil.chkNull(this.totDiscCompleted).doubleValue());
    	
    	return balTon.setScale(2,BigDecimal.ROUND_HALF_UP);
    }
	public BigDecimal getBalLoadTon() {
		BigDecimal balTon = new BigDecimal(0);

		balTon = new BigDecimal((CommonUtil.chkNull(this.totLoadOpenBal).doubleValue() - CommonUtil.chkNull(this.totLoadTotalCompleted).doubleValue()) + CommonUtil.chkNull(this.totLoadCompleted).doubleValue());
		return balTon.setScale(2,BigDecimal.ROUND_HALF_UP);
	}
	...
	protected void setAuditableFields() { 
    	...
    	auditFields.add("checkerHp");
    	auditFields.add("createDttm");
    	auditFields.add("workCommenceDttm");
    	auditFields.add("workCompleteDttm");
    	auditFields.add("fromDttm");
    	auditFields.add("toDttm");
    	auditFields.add("submittedDttm");
	...
	protected void setDateFields() { 
		...
		dateFields.add("workCommenceDttm");
		dateFields.add("workCompleteDttm");
		dateFields.add("fromDttm");
		dateFields.add("toDttm");
		dateFields.add("submittedDttm");
