...
public class GbccCargoOprPlanDetId implements Serializable
{
    ...
    public GbccCargoOprPlanDetId() {
    }

    public GbccCargoOprPlanDetId(String vvCd, Date createDttm, Integer hatchNbr) {
        this.vvCd = vvCd;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GbccCargoOprPlanDetId)) {
            return false;
        }
        GbccCargoOprPlanDetId other = ((GbccCargoOprPlanDetId) o);
        if (this.vvCd == null) {
            if (other.vvCd!= null) {
                return false;
            }
