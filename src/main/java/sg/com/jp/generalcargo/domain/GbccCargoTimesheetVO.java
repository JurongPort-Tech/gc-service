...
public class GbccCargoTimesheetVO extends AuditLogRecord implements Serializable {
	 ...
	 * 
	 */
	private GbccCargoTimesheetId id;
	private String vvCd;
    ...
    private Integer tot_completed_disc;
    private Integer tot_completed_load;
    ...
    private List<GbccCargoTimesheetAct> cargoTimesheetActVO;
    private List<GbccCargoTimesheetEqrental> cargoTimesheetEqRentalVO;
    ...
    public GbccCargoTimesheetVO() {
    }

    public GbccCargoTimesheetVO(String stevCoCd, String checkerNm, String checkerHp, Date workCommenceDttm, Date workCompleteDttm, Date submittedDttm, String lastModifyUserId, Date lastModifyDttm) {
    ...
    public GbccCargoTimesheetVO(GbccCargoTimesheetId id, String stevCoCd, String checkerNm, String checkerHp, Date workCommenceDttm, Date workCompleteDttm, Date submittedDttm, String lastModifyUserId, Date lastModifyDttm) {
        this.id = id;
        this.stevCoCd = stevCoCd;
        this.checkerNm = checkerNm;
        this.checkerHp = checkerHp;
	...
	public Integer getTot_completed_disc() {
		return tot_completed_disc;
	}

	public void setTot_completed_disc(Integer tot_completed_disc) {
		this.tot_completed_disc = tot_completed_disc;
	}

	public Integer getTot_completed_load() {
		return tot_completed_load;
	}

	public void setTot_completed_load(Integer tot_completed_load) {
	...
	public GbccCargoTimesheetId getId() {
        return id;
    }

    public void setId(GbccCargoTimesheetId id) {
        this.id = id;
    }
    ...
    public List<GbccCargoTimesheetAct> getCargoTimesheetActVO() {
    	if (cargoTimesheetActVO == null)
    		cargoTimesheetActVO = new ArrayList<GbccCargoTimesheetAct>();
    	return cargoTimesheetActVO;
    }
    
    public void setCargoTimesheetActVO(List cargoTimesheetActVO) {
    	this.cargoTimesheetActVO = cargoTimesheetActVO;
    }
    
    public List<GbccCargoTimesheetEqrental> getCargoTimesheetEqRentalVO() {
    	if (cargoTimesheetEqRentalVO == null)
    		cargoTimesheetEqRentalVO = new ArrayList<GbccCargoTimesheetEqrental>();
    	
    	return cargoTimesheetEqRentalVO;
    }
    
    public void setCargoTimesheetEqRentalVO(List cargoTimesheetEqRentalVO) {
    	this.cargoTimesheetEqRentalVO = cargoTimesheetEqRentalVO;
    }
