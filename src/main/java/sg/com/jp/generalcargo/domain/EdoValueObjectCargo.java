...
public class EdoValueObjectCargo implements TopsIObject {
...
public EdoValueObjectCargo()
{
	...
	public List<ContainerDetails> getContinerDetails() {
		return container_details;
	}

	public void setContinerDetails(List<ContainerDetails> containervector) {
		container_details = containervector;
	}
	...
	private String hsCodeFrom;
	private String hsCodeTo;
	private String consignee;
	
	public String getHsCodeFrom() {
		return hsCodeFrom;
	}

	public void setHsCodeFrom(String hsCodeFrom) {
		this.hsCodeFrom = hsCodeFrom;
	}
	...
	private List<ContainerDetails> container_details;
	// CH - 3 --> Winstar Changes Start
	private List<HsCodeDetails> HsCode_Details;
	private List<Map<String, String>> hscodeExistingList;
	private boolean ifHsCodeExist;
...
//End ThanhPT6
    ...
    public String getGb_cod_dttm() {
        return gb_cod_dttm;
    }

    public void setGb_cod_dttm(String gb_cod_dttm) {
        this.gb_cod_dttm = gb_cod_dttm;
    }
    
	// CH - 3 --> Winstar Changes Start
	public List<Map<String, String>> gethscodeExistingList() {
		return hscodeExistingList;
	}

	public void sethscodeExistingList(List<Map<String, String>> hscodeExistingList) {
		this.hscodeExistingList = hscodeExistingList;
	}

	public List<HsCodeDetails> getHsCodeDetails() {
		return HsCode_Details;
	}

	public void setHsCodeDetails(List<HsCodeDetails> HsCodeDetails) {
		HsCode_Details = HsCodeDetails;
	}

	public boolean getifHsCodeExist() {
		return ifHsCodeExist;
	}

	public void setifHsCodeExist(boolean ifHsCode_Exist) {
		this.ifHsCodeExist = ifHsCode_Exist;
	}
	// CH - 3 --> Winstar Changes End
