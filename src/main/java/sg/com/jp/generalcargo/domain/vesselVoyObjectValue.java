...
public class vesselVoyObjectValue  implements Serializable{

	private static final long serialVersionUID = -8311001015262968358L;

	public vesselVoyObjectValue()
    {
    ...
    public Vector getContinerDetails()
    {
        return container_details;
    }

    public void setContinerDetails(Vector vector)
    {
        container_details = vector;
    }
    ...
    private Vector container_details;
