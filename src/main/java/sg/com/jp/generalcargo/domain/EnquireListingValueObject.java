...
public class EnquireListingValueObject implements TopsIObject  {
...
private static final long serialVersionUID = 4618930304758089051L;
	...
	private List<EnquireListingAppValueObject> appValueObjects;
	...
	//UPDATE variables for trailer by thanhbtl6b on 20 Sept 2013 
	...
	//END UPDATE variables for trailer by thanhbtl6b on 20 Sept 2013
	...
	public List<EnquireListingAppValueObject> getAppValueObjects() {
		if (appValueObjects == null) {
			appValueObjects = new ArrayList<EnquireListingAppValueObject>();
		}
		return appValueObjects;
	}

	public void setAppValueObjects(List<EnquireListingAppValueObject> appValueObjects) {
		this.appValueObjects = appValueObjects;
	}
	...
	public String getTrailerTypeName() {
		if(trailerTypeCode!=null){
			return (String)MiscAppConstValueObject.TRAILER_TYPE_TABLE.get(trailerTypeCode);
		}
