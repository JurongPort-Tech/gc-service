...
public class GbccCargoTallysheetDetId implements Serializable
{
    ...
    private String blBkNbr;

    public GbccCargoTallysheetDetId() {
    }

    public GbccCargoTallysheetDetId(String vvCd, Date createDttm, String oprType, Integer hatchNbr, String blBkNbr) {
        this.vvCd = vvCd;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GbccCargoTallysheetDetId)) {
            return false;
        }
        GbccCargoTallysheetDetId other = ((GbccCargoTallysheetDetId) o);
        if (this.vvCd == null) {
            if (other.vvCd!= null) {
                return false;
            }
        ...
        if (this.blBkNbr == null) {
            if (other.blBkNbr!= null) {
                return false;
            }
        } else {
            if (!this.blBkNbr.equals(other.blBkNbr)) {
                return false;
            }
        }
        return true;
