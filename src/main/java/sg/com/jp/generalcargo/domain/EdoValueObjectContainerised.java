...
public class EdoValueObjectContainerised implements Serializable

{
	...
	String vec4 = "";
	String vec5 = "";
	private String strCntrNum = "";
	private String strStuffDt = "";
	...
	public String getAAName()
	{
        ...
        public void setStuffDate(String szStuffDt)
        {
            strStuffDt = szStuffDt;
        }
        public String getStuffDate()
        {
            return strStuffDt;
        }
