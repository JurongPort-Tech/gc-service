...
public class ManifestActionTrail  implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private Long mft_act_trl_id;
	...
	public Long getMft_act_trl_id() {
		return mft_act_trl_id;
	}

	public void setMft_act_trl_id(Long mft_act_trl_id) {
		this.mft_act_trl_id = mft_act_trl_id;
	}
